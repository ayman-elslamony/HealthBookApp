    ...
    Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(color: isAnalysis ==true?Colors.grey:Colors.blue)
        ),
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Column(
            children: <Widget>[
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: infoWidget.titleButton.copyWith(
                        color:isAnalysis ==true?Colors.grey[600]:Colors.blue,
              ...
              Padding(
                ...
                child: Divider(
                  color: isAnalysis ==true?Colors.grey:Colors.blue,
                  height: 3,
                ),
              ),
              ListView.builder(
                                  ...
                                  x[index].name==null?SizedBox():Padding(
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Text('Name:',
                                            style:
                                            infoWidget.subTitle.copyWith(color: isAnalysis ==true?Colors.grey[600]:Colors.blue)),
                                        Expanded(
                                          child: Padding(
